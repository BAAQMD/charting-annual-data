...
**NOTE:** If you are trying this, you might notice that the throughput forecast doesn't follow the same trajectory as the NOx forecast. See the [Appendix](#appendix-BY2011-cat_283-forecast) for an explanation and an advanced exercise.
