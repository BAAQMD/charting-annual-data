...
```{block type="note"}
If you are trying this, you might notice that the throughput forecast doesn't follow the same trajectory as the NO~x~ forecast. See the [Appendix](#appendix-case-cat_283) for an explanation and an advanced exercise.
```
