...
Let's start by pulling BY2011 growth factors from DataBank. `DB_growth_profiles()` takes care of normalizing them, making the assumption that BY2011 should ne mornalized to CY2011.
